...
export default function SellPage() {
  ...
  const validateStep = () => {
    switch (step) {
      case 1:
        return formData.productName && formData.category && formData.quantity && formData.price;
      case 2:
        return formData.location && formData.district && formData.state && formData.pincode;
      case 3:
        return formData.contactName && formData.contactPhone && formData.deliveryOptions.length > 0;
      default:
        return true;
    }
  };
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="50"
                      className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {deliveryOptions.map((option) => (
                      <label
                        key={option.id}
                        className="flex items-center gap-3 p-4 rounded-xl border border-gray-300 hover:bg-green-50 cursor-pointer transition"
                      >
                        <input
                          type="checkbox"
            ...
            <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
              ...
              {step < 4 ? (
                <button
                  ...
                  className="ml-auto px-6 py-3 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 text-white font-semibold hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Next Step
                </button>
              ) : (
